...
def _script_instructions() -> str:
    ...
    return (
        ...
        "\n\nPRONUNTIE CUVINTE STRAINE (FOARTE IMPORTANT): in voice_over si in textul "
        "segmentelor, de fiecare data cand folosesti un nume propriu, cuvant, expresie sau "
        "termen in limba engleza sau alta limba straina (nume de persoane, orase straine, "
        "branduri, filme, jocuri, produse, termeni tehnici de tipul \"smartphone\", \"AI\", "
        "\"gaming\" etc.), marcheaza-l incluzandu-l intre simbolul ~ la inceput si la final, "
        "exact cum se scrie corect in limba originala "
        "(exemplu: \"~Elon Musk~ a anuntat un nou proiect numit ~Neuralink~.\"). "
        "NU marca cuvintele romanesti, nici cele straine deja asimilate complet in limba romana "
        "cu pronuntie romaneasca uzuala. Aceste marcaje vor fi citite cu o voce nativa engleza "
        "pentru o pronuntie corecta, deci este esential sa le folosesti pentru orice nume sau "
        "cuvant care nu se pronunta in stil romanesc."
