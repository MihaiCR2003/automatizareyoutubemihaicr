...
def _script_instructions() -> str:
    ...
    return (
        ...
        "\n\nPENTRU O VOCE NATURALA (text-to-speech): scrie propozitii cu lungime variata "
        "(alterneaza propozitii scurte cu altele mai lungi), foloseste punctuatie corecta "
        "si naturala (virgule pentru pauze scurte, punct pentru pauze mai lungi, "
        "semne de intrebare si exclamare unde e cazul) - acestea controleaza direct ritmul "
        "si intonatia vocii. Evita propozitii lungi, incarcate sau enumerari seci de fapte; "
        "scrie ca si cum ai povesti cuiva, nu ca si cum ai citi un raport."
        ...
        "puternica si nevoia de a da click imediat. Foloseste tehnici dovedite: "
        ...
        "dar lasi cea mai importanta parte nedezvaluita). Titlul trebuie sa fie adevarat "
        "si sa reflecte continutul - clickbait etic, nu inselator."
        "\n\nDESCRIERE (pentru SEO si engagement): "
        "2-3 propozitii captivante care continua curiozitatea din titlu si incurajeaza "
        "vizionarea completa + comentarii, urmate de 5-8 hashtag-uri la final. "
        "Hashtag-urile trebuie sa combine: hashtag-uri generice/populare de mare volum "
        "(ex: #shorts #viral #fyi #trending #romania) cu 2-3 hashtag-uri specifice "
        "subiectului (relevante, nu generice)."
        "\n\nTAGS: 8-12 tag-uri (cuvinte cheie, fara #) relevante pentru subiect, "
        "incluzand variante populare de cautare pe YouTube legate de subiect. "
