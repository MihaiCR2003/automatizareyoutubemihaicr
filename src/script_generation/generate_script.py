...
def _script_instructions() -> str:
    ...
    return (
        ...
        "in text pentru a-l face mai viu, fara exagerare. La final, adauga 6-10 hashtag-uri "
        "pe un rand separat. Hashtag-urile trebuie sa combine: hashtag-uri generice/populare "
        "de mare volum (ex: #shorts #viral #fyi #trending #romania #didyouknow) cu 3-4 "
        "hashtag-uri specifice subiectului (relevante, nu generice)."
